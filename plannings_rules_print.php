<?
  ...
  $largeur=$largeur/2;
?>
<HTML><HEAD><TITLE>Planning de l'orga <? print($nom_orga); ?></TITLE><LINK href="print.css" type="text/css" rel="stylesheet"></HEAD><BODY><TABLE width="100%" cellspacing="0" cellpadding="3">  <TR>    <TD>&nbsp;</TD>  </TR><FORM method="POST" name="form_choix" action="main.php?file=plannings&action=rules">  <TR>    <TD>      <TABLE>        <TR><?  if ($id_orga_prev!="")  {?>          <TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>          <TD>            <A href="plannings_rules_print.php?id_orga=<? print($id_orga_prev); ?>"><B>Orga pr&eacute;c&eacute;dent</B></A>          </TD>
<?
  }
  if ($id_orga_next!="")
  {
?>          <TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>          <TD>            <A href="plannings_rules_print.php?id_orga=<? print($id_orga_next); ?>"><B>Orga suivant</B></A>          </TD><?  }?>        </TR>      </TABLE>    </TD>  </TR></FORM>  <TR>    <TD align="center">      <H1><? print($nom_orga); ?></H1>    </TD>  </TR>  <TR>    <TD align="right">      <TABLE width="100%" cellspacing="0" cellpadding="3">
<?
  ...
  $html_array[$j]=$html_array[$j]."<TR><TD BGCOLOR=\"".$color."\" WIDTH=\"1%\" COLSPAN=\"2\">".nl2br($consigne).$lieu.$nom_resp.$matos.$coequipiers.$vehicule."</TD></TR>";
