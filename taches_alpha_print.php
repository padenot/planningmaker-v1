<?
  ...
  isset($_GET['resp']) ? $resp = $_GET['resp'] : $resp = "";
  
  include('connect_db.php');
  include('functions.php');
  include('classes.php');
if($resp!=""){
	$req_sql="SELECT taches.*, lieux.nom_lieu FROM taches, lieux WHERE taches.id_lieu=lieux.id_lieu ORDER BY taches.id_resp";
}
	else{
...
<TABLE WIDTH="1%" CELLSPACING="0" CELLPADDING="3">
  ...
  <TR bgcolor="#CCCCCC">
	...
	<TD ALIGN="center" nowrap> <B>consigne&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</B> </TD>
    <TD ALIGN="center">
      <B>Responsable</B>
    </TD>
  </TR>
