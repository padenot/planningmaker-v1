<?
  isset($_GET['id_activite']) ? $id_activite = $_GET['id_activite'] : $id_activite = ""; 

  $req_sql="SELECT * FROM activites WHERE id_activite='".$id_activite."'";
...
<FORM method="POST" name="form" action="db_action.php?db_action=update_activite">
  <TR>
    <TD colspan="3">&nbsp;</TD>
  </TR>
  <TR CLASS="activites_top">
    <TD colspan="3">
      <B>Modification d'une activit&eacute;</B>
    </TD>
  </TR>
...
?>
  ...
  <TR CLASS="activites">
    ...
    <TD WIDTH="1%">
      <INPUT TYPE="text" NAME="titre" VALUE="<? print($activites_array[$i]->titre); ?>" SIZE="20" MAXLENGTH="40">
      <INPUT TYPE="hidden" NAME="id_activite" VALUE="<? print($activites_array[$i]->id_activite); ?>">
    </TD>
  </TR>
  <TR CLASS="activites">
    <TD>&nbsp;&nbsp;&nbsp;</TD>
    ...
    <TD WIDTH="1%">
      <TEXTAREA NAME="consigne" COLS="22" ROWS="4" WRAP="virtual"><? print($activites_array[$i]->consigne); ?></TEXTAREA>
    </TD>
  </TR>
  <TR CLASS="activites">
    <TD>&nbsp;&nbsp;&nbsp;</TD>
    ...
    <TD WIDTH="1%">
      <INPUT TYPE="text" NAME="begin_time" VALUE="<? print(substr(date_en_to_fr($activites_array[$i]->begin_time),0,16)); ?>" SIZE="20" MAXLENGTH="40">
    </TD>
  </TR>
  <TR CLASS="activites">
    <TD>&nbsp;&nbsp;&nbsp;</TD>
    ...
    <TD WIDTH="1%">
      <INPUT TYPE="text" NAME="end_time" VALUE="<? print(substr(date_en_to_fr($activites_array[$i]->end_time),0,16)); ?>" SIZE="20" MAXLENGTH="40">
    </TD>
  </TR>
  <TR CLASS="activites">
    <TD>&nbsp;&nbsp;&nbsp;</TD>
    ...
    <TD WIDTH="1%">
      <INPUT TYPE="text" NAME="duree" VALUE="<? print(substr($activites_array[$i]->duree,0,5)); ?>" SIZE="20" MAXLENGTH="40">
    </TD>
  </TR>
  <TR CLASS="activites">
    <TD>&nbsp;&nbsp;&nbsp;</TD>
...
<?
    ...
    for ($j=0;$j<count($vehicules_array);$j++)
    {
      $is_selected="";
      if ($vehicules_array[$j]->id_vehicule==$activites_array[$i]->id_vehicule) $is_selected="selected";
?>

        <OPTION <? print($is_selected); ?> VALUE="<? print($vehicules_array[$j]->id_vehicule); ?>"><? print($vehicules_array[$j]->nom); ?></OPTION>
...
<?
    ...
    {
      $is_selected="";
      if ($lieux_array[$j]->id_lieu==$activites_array[$i]->id_lieu) $is_selected="selected";
?>

        <OPTION <? print($is_selected); ?> VALUE="<? print($lieux_array[$j]->id_lieu); ?>"><? print($lieux_array[$j]->nom); ?></OPTION>
