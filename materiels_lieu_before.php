...
if ($id_lieu=="")
  ...
  $req_sql="SELECT materiels.*, lieux.nom_lieu FROM materiels, lieux WHERE materiels.id_lieu_before='".$id_lieu."' AND materiels.id_lieu=lieux.id_lieu ORDER BY materiels.id_categorie";
...
<TABLE WIDTH="1%" CELLSPACING="0" CELLPADDING="3">
  <FORM method="POST" name="form" action="main.php?file=materiels&action=lieu_before" >
  <TR>
    <TD colspan="6">&nbsp;</TD>
  </TR>
  <TR CLASS="taches_top">
    <TD colspan="6" nowrap>
      <B>Choisis un lieu de pré-stockage</B>&nbsp;&nbsp;&nbsp;
